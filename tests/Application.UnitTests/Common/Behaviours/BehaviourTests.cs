using CleanArchitectureSolutionTemplate.Application.Common.Behaviours;
...
namespace CleanArchitectureSolutionTemplate.Application.UnitTests.Common.Behaviours
{
