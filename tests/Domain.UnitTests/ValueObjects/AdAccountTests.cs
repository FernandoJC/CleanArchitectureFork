using CleanArchitectureSolutionTemplate.Domain.Exceptions;
using CleanArchitectureSolutionTemplate.Domain.ValueObjects;
using Shouldly;
using Xunit;

namespace CleanArchitectureSolutionTemplate.Domain.UnitTests.ValueObjects
{
